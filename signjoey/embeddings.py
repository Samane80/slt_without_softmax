...
class MaskedNorm(nn.Module):
    """معادل FP32 از MaskedNorm — اسم .norm عمدا مطابق نسخه‌ی کوانتیزه‌ست."""
...
class Embeddings(nn.Module):
    """معادل FP32 از Embeddings (embedding متن/گلاس سمت دیکودر)."""
...
class SpatialEmbeddings(nn.Module):
    """معادل FP32 از SpatialEmbeddings (embedding فریم‌های ویدیو سمت انکودر)."""
